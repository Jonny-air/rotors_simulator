...
void GazeboPayloadPlugin::OnUpdate()
{
    ...
    double zeta = 0.5;                // damping ratio of connection
    double mass = 1.0;               // payload mass (<<aircraft mass) -> needs to match simulated mass!
    double inertia = 0.4*mass*0.0625; // inertia of solid sphere: 0.4*m*r²
